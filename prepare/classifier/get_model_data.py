...
def model_evaluation(json_opts, test_dataset, save_directory):
...
model_config_path = Path(
    workflow_json_opts.masking_config.masking_config_anat.model_config_path)

# temp
model_config_path = "/home/hendrik/src/MLEBE/mlebe/training/checkpoints/2020_7_7_15_33_19/trained_mlebe_config_func.json"
...
model_evaluation(model_json_opts, test_dataset, save_dir)
