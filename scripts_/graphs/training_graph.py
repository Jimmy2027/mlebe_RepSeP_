...
pic.set_node(text=nodes.template, name='template', options="mask, above of=processed_volume, yshift=4cm")
...
pic.set_line('unprocessed_volume', 'processed_volume', edge_options='line width=0.1cm', label="SAMRI",
             label_pos="south")
pic.set_line('template', 'processed_volume', edge_options='line width=0.1cm')
